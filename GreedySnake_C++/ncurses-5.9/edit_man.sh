...
*.[0-9]*)
	...
	if test ! -f /Users/huangdaxin/Documents/GitHub/Little-Games/GreedySnake_C++/ncurses-5.9/man_alias.sed ; then
cat >>/Users/huangdaxin/Documents/GitHub/Little-Games/GreedySnake_C++/ncurses-5.9/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /Users/huangdaxin/Documents/GitHub/Little-Games/GreedySnake_C++/ncurses-5.9/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /Users/huangdaxin/Documents/GitHub/Little-Games/GreedySnake_C++/ncurses-5.9/man_alias.sed | sort -u`
	...
	sed	-f /Users/huangdaxin/Documents/GitHub/Little-Games/GreedySnake_C++/ncurses-5.9/man_alias.sed \
		< $i >$TMP
